            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-secondary text-sm mb-3">
                  Our current baseline platform has been developed with a focus on banking risk management. While the core architecture—context management, skills, patterns, and goal alignment—applies equally to insurance, we are actively seeking <strong className="text-white">founding members from the insurance and reinsurance industry</strong> to help adapt and extend the platform for insurance-specific use cases.
                </p>
