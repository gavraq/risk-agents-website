      ...
      <section className="py-20 px-6 bg-slate-900">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-gradient-to-br from-amber-900/20 to-orange-900/20 rounded-2xl p-8 border border-amber-900/30">
              <h3 className="text-xl font-bold text-amber-400 mb-6">Founding Member Benefits</h3>
      ...
      <section className="py-20 px-6 bg-slate-900">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="bg-slate-800/50 rounded-2xl p-8 border border-amber-900/30">
              <h3 className="text-xl font-bold text-amber-400 mb-6">Ideal Founding Members</h3>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-6">
              <div className="w-12 h-12 rounded-full bg-amber-600 flex items-center justify-center text-white font-bold flex-shrink-0">1</div>
